...
/// solid Glacier-navy `GolemLaunchScreen.storyboard`, committed and never
...
void main() {
  ...
  if (!storyboard.contains('red="0.05882352941"') ||
      storyboard.contains('<imageView')) {
    throw StateError(
      'GolemLaunchScreen.storyboard must stay a solid Glacier-navy screen '
